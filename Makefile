...
dwl: dwl.o util.o net-tapesoftware-dwl-wm-unstable-v1-protocol.o
	$(CC) dwl.o util.o net-tapesoftware-dwl-wm-unstable-v1-protocol.o $(DWLCFLAGS) $(LDFLAGS) $(LDLIBS) -o $@
...
install: dwl
	...
	ln -sf $(CURDIR)/startdwl $(DESTDIR)$(PREFIX)/bin/startdwl
...
uninstall:
	rm -f $(DESTDIR)$(PREFIX)/bin/dwl $(DESTDIR)$(PREFIX)/bin/startdwl \
